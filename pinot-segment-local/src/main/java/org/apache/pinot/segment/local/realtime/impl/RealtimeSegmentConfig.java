...
public class RealtimeSegmentConfig {
  ...
  private RealtimeSegmentConfig(String tableNameWithType, String segmentName, String streamName, Schema schema,
      ...
      @Nullable String upsertDeleteColumn, PartitionUpsertMetadataManager partitionUpsertMetadataManager,
    ...
    _upsertDeleteColumn = upsertDeleteColumn;
  ...
  public String getUpsertDeleteColumn() {
    return _upsertDeleteColumn;
  }
  ...
  public static class Builder {
    ...
    private String _upsertDeleteColumn;
    ...
    public Builder setUpsertDeleteColumn(String upsertDeleteColumn) {
      _upsertDeleteColumn = upsertDeleteColumn;
      return this;
    }
    ...
    public RealtimeSegmentConfig build() {
      ...
      return new RealtimeSegmentConfig(_tableNameWithType, _segmentName, _streamName, _schema, _timeColumnName,
          ...
          _nullHandlingEnabled, _consumerDir, _upsertMode, _upsertComparisonColumns, _upsertDeleteColumn,
