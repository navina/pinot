...
public class QueryOptionsUtils {
  ...
  public static boolean isUseBrokerResultCache(Map<String, String> queryOptions) {
    return Boolean.parseBoolean(queryOptions.get(QueryOptionKey.USE_BROKER_RESULT_CACHE));
  }
